...
function I() {
  console.log("turn light"), document.documentElement.classList.remove("dark"), localStorage.setItem("theme", "light");
}
class Z extends HTMLElement {
  ...
  connectedCallback() {
    ...
    o.appendChild(j.content.cloneNode(!0));
    const t = window.matchMedia("(prefers-color-scheme: dark)"), r = o.querySelector(".toggle");
    localStorage.theme === "dark" ? S() : localStorage.theme === "light" ? (r.classList.toggle("dark"), I()) : t.matches && document.documentElement.classList.add("dark"), r.addEventListener("click", (v) => {
      r.classList.toggle("dark"), r.classList.contains("dark") ? I() : S();
    });
  }
}
customElements.define("dark-light-mode", Z);
const C = {
  "zh-CN": {
    ecosystem: "生态系统",
    docsTitle: "组件库文档",
...
let n = (M = class extends e {
  constructor() {
    ...
    m(this, b, void 0);
    m(this, f, void 0);
    s(this, "logo", "https://m.hellobike.com/resource/helloyun/13459/H3kyK_quarkc-light.png?x-oss-process=image/quality,q_80");
    s(this, "githubUrl", "https://github.com/hellof2e/quark-design");
    s(this, "homeUrl", "https://quark.hellobike.com");
    s(this, "guideUrl", "");
    s(this, "componentUrl", "");
    s(this, "isQuarkc", !1);
    s(this, "activeNav", "");
    s(this, "searchRef", B());
    s(this, "_quarkdLogoSwitch", () => {
    ...
    d(this, g, localStorage.getItem("language") === "zh-CN"), d(this, l, i(this, g) ? C["zh-CN"] : C["en-US"]), d(this, p, `https://${location.host}`), d(this, b, ~location.host.indexOf("quark.hellobike.com")), d(this, f, !1), ~["vanilla", "angular", "svelte"].indexOf(location.host.split("-")[0]) && d(this, f, !0);
  }
  componentDidMount() {
    localStorage.getItem("language") || localStorage.setItem("language", "en-US"), localStorage.getItem("theme") || localStorage.setItem("theme", "light"), location.hash.indexOf("guide") > -1 ? this.activeNav = "guide" : location.hash.indexOf("component") > -1 && (this.activeNav = "component"), this.homeUrl = i(this, p), this.guideUrl = `${i(this, p)}/#/${localStorage.getItem("language")}/guide/quickstart`, this.componentUrl = `${i(this, p)}/#/${localStorage.getItem("language")}/component/button`;
    const r = {
      container: this.searchRef.current,
      appId: "EA4BY59U66",
      apiKey: "5d1fd7c976a98a74421011f1374dd200"
    };
    location.host.indexOf("vue-quarkdesign") > -1 ? (y({
      ...r,
      indexName: localStorage.getItem("language") === "en-US" ? "ENDoc" : "CNDoc"
    }), this._quarkdLogoSwitch()) : location.host.indexOf("react-quarkdesign") > -1 ? (y({
      ...r,
      indexName: localStorage.getItem("language") === "en-US" ? "react-ENDoc" : "react-CNDoc"
    }), this._quarkdLogoSwitch()) : (this._quarkcLogoSwitch(), this.githubUrl = "https://github.com/hellof2e/quark"), y({
      ...r,
      indexName: localStorage.getItem("language") === "en-US" ? "ENDoc" : "CNDoc"
    });
  }
  render() {
    return e.h(
      ...
      i(this, f) ? e.h(
        ...
        e.h("a", { href: "https://vue-quarkdesign.hellobike.com" }, "文档更新中，可先参照 Vue 文档（Coming soon...）")
      ) : null,
      e.h(
        "header",
        { class: "header" },
              ...
              e.h(
                ...
                i(this, b) ? null : e.h(
                  ...
                  e.h(
                    ...
                    e.h("a", { href: this.guideUrl }, i(this, l).guide)
                  ),
                  e.h(
                    "div",
                    { class: this.activeNav === "component" ? "nav-item menu active-nav" : "nav-item menu" },
                    e.h("a", { href: this.componentUrl }, i(this, l).component)
                  )
                ),
                e.h(
                  "div",
                    ...
                    e.h(
                      ...
                      e.h(
                        ...
                        e.h(
                          ...
                          e.h("p", { class: "menu-group-title" }, i(this, l).docsTitle),
                          i(this, l).stacks.map((t) => e.h(
                            "a",
                            { key: t, class: "link menu-link", href: `https://${t}-quarkdesign.hellobike.com/#/${i(this, g) ? "zh-CN" : "en-US"}/component/button`, target: "_blank", rel: "noopener noreferrer" },
                            t,
                            " ",
                            i(this, g) ? "文档" : "documentation",
                            e.h(
                              "svg",
                ...
                e.h(
                  ...
                  e.h(
                    "button",
                    { type: "button" },
                    e.h("span", null, i(this, l).ecosystem),
                    e.h(
                      "svg",
                      { xmlns: "http://www.w3.org/2000/svg", "aria-hidden": "true", focusable: "false", viewBox: "0 0 24 24", class: "flyout-button-text-icon" },
                      e.h("path", { d: "M12,16c-0.3,0-0.5-0.1-0.7-0.3l-6-6c-0.4-0.4-0.4-1,0-1.4s1-0.4,1.4,0l5.3,5.3l5.3-5.3c0.4-0.4,1-0.4,1.4,0s0.4,1,0,1.4l-6,6C12.5,15.9,12.3,16,12,16z" })
                    ...
                    e.h(
                      ...
                      e.h(
                        ...
                        e.h(
                          "div",
                          { class: "menu-item-group" },
                          e.h("p", { class: "menu-group-title" }, i(this, l).officialLibrary),
                          e.h(
                            "a",
                        ...
                        e.h(
                          "div",
                          { class: "menu-item-group" },
                          e.h("p", { class: "menu-group-title" }, i(this, l).resources),
                          e.h(
                            "a",
...
}, g = new WeakMap(), l = new WeakMap(), p = new WeakMap(), b = new WeakMap(), f = new WeakMap(), M);
h([
  u()
...
h([
  u()
], n.prototype, "isQuarkc", void 0);
h([
  u()
], n.prototype, "activeNav", void 0);
n = h([
  R({ tag: "quark-doc-header", style: z })
], n);
const H = n;
export {
  H as default
