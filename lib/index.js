...
var L = (i, o, t) => o in i ? j(i, o, { enumerable: !0, configurable: !0, writable: !0, value: t }) : i[o] = t;
var l = (i, o, t) => (L(i, typeof o != "symbol" ? o + "" : o, t), t), A = (i, o, t) => {
  if (!o.has(i))
    throw TypeError("Cannot " + t);
};
var a = (i, o, t) => (A(i, o, "read from private field"), t ? t.call(i) : o.get(i)), p = (i, o, t) => {
  if (o.has(i))
    throw TypeError("Cannot add the same private member more than once");
  o instanceof WeakSet ? o.add(i) : o.set(i, t);
}, d = (i, o, t, s) => (A(i, o, "write to private field"), s ? s.call(i, t) : o.set(i, t), t);
...
let n = (C = class extends e {
  constructor() {
    ...
    d(this, u, localStorage.getItem("language") === "zh-CN"), d(this, r, a(this, u) ? I["zh-CN"] : I["en-US"]), d(this, m, location.origin), d(this, f, !1), d(this, x, location.host.indexOf("quarkc.hellobike.com") > -1), d(this, g, location.hostname.split("-").length > 1 ? location.hostname.split("-")[0] : !1), ~["vanilla", "angular", "svelte"].indexOf(location.hostname.split("-")[0]) && d(this, f, !0);
  }
  componentDidMount() {
    this.navActive(), localStorage.getItem("language") || localStorage.setItem("language", "zh-CN"), localStorage.getItem("theme") || localStorage.setItem("theme", "light"), this.homeUrl = a(this, m), this.guideUrl = `${a(this, m)}/quarkd-docs/${a(this, g)}/#/${localStorage.getItem("language")}/guide/quickstart`, this.componentUrl = `${a(this, m)}/quarkd-docs/${a(this, g)}/#/${localStorage.getItem("language")}/component/button`;
    const s = {
      container: this.searchRef.current,
      appId: "EA4BY59U66",
      apiKey: "5d1fd7c976a98a74421011f1374dd200"
    };
    location.pathname.indexOf("vue") > -1 ? w({
      ...s,
      indexName: localStorage.getItem("language") === "en-US" ? "ENDoc" : "CNDoc"
    }) : location.pathname.indexOf("react") > -1 && w({
      ...s,
              ...
              e.h(
                ...
                a(this, x) ? null : e.h(
                  ...
                  e.h(
                    ...
                    e.h("a", { href: this.guideUrl }, a(this, r).guide)
                  ),
                  e.h(
                    "div",
                    { class: this.activeNav === "component" ? "nav-item menu active-nav" : "nav-item menu" },
                    e.h("a", { href: this.componentUrl }, a(this, r).component)
                  )
                ),
                e.h(
                  "div",
                    ...
                    e.h(
                      ...
                      e.h(
                        ...
                        e.h(
                          ...
                          e.h("p", { class: "menu-group-title" }, a(this, r).docsTitle),
                          a(this, r).stacks.map((t) => e.h(
                            "a",
                            { key: t, class: "link menu-link", href: `https://${t}-quarkd.hellobike.com/#/${a(this, u) ? "zh-CN" : "en-US"}/component/button`, target: "_blank", rel: "noopener noreferrer" },
                            t,
                            " ",
                            a(this, u) ? "文档" : "documentation",
                            e.h(
                              "svg",
                ...
                e.h(
                  "div",
                  { class: "nav-item menu" },
                  e.h("a", { target: "_blank", href: "https://quark-ecosystem.github.io/quarkd-docs/playground/" }, "Playground")
                ),
                e.h(
                  "div",
                  { class: "nav-item flyout" },
                  e.h(
                    "button",
                    { type: "button" },
                    e.h("span", null, a(this, r).ecosystem),
                    e.h(
                      "svg",
                      { xmlns: "http://www.w3.org/2000/svg", "aria-hidden": "true", focusable: "false", viewBox: "0 0 24 24", class: "flyout-button-text-icon" },
                      e.h("path", { d: "M12,16c-0.3,0-0.5-0.1-0.7-0.3l-6-6c-0.4-0.4-0.4-1,0-1.4s1-0.4,1.4,0l5.3,5.3l5.3-5.3c0.4-0.4,1-0.4,1.4,0s0.4,1,0,1.4l-6,6C12.5,15.9,12.3,16,12,16z" })
                    ...
                    e.h(
                      ...
                      e.h(
                        ...
                        e.h(
                          "div",
                          { class: "menu-item-group" },
                          e.h("p", { class: "menu-group-title" }, a(this, r).officialLibrary),
                          e.h(
                            "a",
                        ...
                        e.h(
                          "div",
                          { class: "menu-item-group" },
                          e.h("p", { class: "menu-group-title" }, a(this, r).resources),
                          e.h(
                            "a",
...
}, u = new WeakMap(), r = new WeakMap(), m = new WeakMap(), f = new WeakMap(), x = new WeakMap(), g = new WeakMap(), C);
c([
  G()
