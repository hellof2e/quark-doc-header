import { QuarkElement, createRef, Fragment, state, customElement } from 'quarkc';
...
let MyComponent = class MyComponent extends QuarkElement {
  ...
  constructor() {
    ...
    this.#curHost = `https://${location.host}`;
    this.#isQuarkc = ~location.host.indexOf('quark.hellobike.com');
  ...
  render() {
    return QuarkElement.h(Fragment, null, this.#isDocNotReady ? QuarkElement.h("div", {
      className: "toper-message"
    }, QuarkElement.h("a", {
      href: "https://vue-quarkdesign.hellobike.com"
    }, "\u6587\u6863\u66F4\u65B0\u4E2D\uFF0C\u53EF\u5148\u53C2\u7167 Vue \u6587\u6863\uFF08Coming soon...\uFF09")) : null, QuarkElement.h("header", {
      class: "header"
...
__decorate([state()], MyComponent.prototype, "logo", void 0);
...
__decorate([state()], MyComponent.prototype, "activeNav", void 0);
